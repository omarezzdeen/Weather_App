...
object Constants {
    ...
    const val baseUrlTest = "https://api.openweathermap.org/data/2.5/onecall?&units=metric&exclude=minutely&appid=8c9a22ad31737b2f20be08e6f46f7998&lat=31.51667&lon=34.48333"

    const val TAG = "OE_PROGRAMMER"
    const val TAG_CLIENT = "DataManager"
